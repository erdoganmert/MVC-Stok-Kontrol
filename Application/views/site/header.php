...
<head>
    ...
    <title><?=$this->myUserInfo['ad']?> | Panel</title>
...
<div class="wrapper">
    ...
    <header class="main-header">
        ...
        <a href="<?= SITE_URL ?>" class="logo">
            ...
            <span class="logo-lg"><b>MVC</b> Stok</span>
        </a>
        ...
        <nav class="navbar navbar-static-top">
            ...
            <div class="navbar-custom-menu">
                <ul class="nav navbar-nav">
                    <li>
                        <a href="#" data-toggle="control-sidebar"><i class="fa fa-paint-brush" style="margin-right: 5px;"></i>Tema Renkleri</a>
                    </li>
                </ul>
            </div>
        </nav>
