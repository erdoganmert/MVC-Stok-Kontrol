...
define("DB_NAME","mvcStok");
define("DB_USERNAME","root");
define("DB_PASSWORD","root");



define("SITE_URL","http://localhost/mvcstok");
define("PROFILE_PICTURES",SITE_URL."/Application/profilePictures");
...
define("IZINLER",['kategori','urun','musteri','stok','kasa','fatura','rapor','kullanici']);